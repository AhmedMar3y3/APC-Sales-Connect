...
<div class="container">
    ...
    <form action="{{ route('admin.target.update', [$representative->id, $target->id]) }}" method="POST">
        @csrf
        @method('PUT')
    ...
    <a href="{{ route('admin.target.view', $representative->id) }}" class="btn btn-secondary mt-3">Back to Targets</a>
</div>
@endsection
