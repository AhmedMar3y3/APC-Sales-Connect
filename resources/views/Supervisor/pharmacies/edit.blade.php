...
<div class="container">
    <h1>Edit Pharmacy</h1>
    <form action="{{ route('supervisor.pharmacies.update', $pharmacy->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <a href="{{ route('supervisor.pharmacies.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
