...
<div class="container">
    <h1>Edit Doctor</h1>
    <form action="{{ route('leader.doctors.update', $doctor->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <a href="{{ route('leader.doctors.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
