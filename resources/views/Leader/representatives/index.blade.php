...
<div class="container">
    ...
    <!-- Search Form -->
    <form action="{{ route('leader.representatives.index') }}" method="GET" class="mb-3">
        ...
        <tbody>
            @forelse($representatives as $representative)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('leader.representatives.show', $representative->id) }}" class="btn btn-info btn-sm">
                            <i class="fas fa-eye"></i> View
                        </a>
                        <a href="{{ route('leader.target.create', $representative->id) }}" class="btn btn-success btn-sm">
                            <i class="fas fa-plus"></i> Add Target
                        </a>
                        <a href="{{ route('leader.target.view', $representative->id) }}" class="btn btn-primary btn-sm">
