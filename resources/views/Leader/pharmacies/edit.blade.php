...
<div class="container">
    <h1>Edit Pharmacy</h1>
    <form action="{{ route('leader.pharmacies.update', $pharmacy->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <a href="{{ route('leader.pharmacies.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
