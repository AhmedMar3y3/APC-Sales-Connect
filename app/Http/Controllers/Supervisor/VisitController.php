...
class VisitController extends Controller
{
    ...
    public function showVisit($representativeId, $visitId)
    {
        ...
        if (!$representative || !$representative->visits->first()) {
            return redirect()->route('supervisor.representatives.index')->with('error', 'Visit not found');
        }

        $visit = $representative->visits->first();

        return view('Supervisor.representatives.visits', compact('representative', 'visit'));
    }
    public function create($representativeId)
    {
        ...
        $doctors = Doctor::all();
        return view('Supervisor.representatives.createVisit', compact('representative', 'medications', 'pharmacies', 'doctors'));
    }
    ...
    public function store(storeVisitRequest $request, $representativeId)
    {
        ...
        return redirect()->route('supervisor.representatives.show', $representativeId)
    ...
    public function edit($representativeId, $visitId)
    {
        ...
        return view('Supervisor.representatives.editVisit', compact('representative', 'visit', 'medications'));
    }
