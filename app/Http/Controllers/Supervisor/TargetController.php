...
class TargetController extends Controller
{
    ...
    public function viewTargets($representativeId)
    {
        ...
        return view('Supervisor.target.view', compact('representative', 'targets'));
    }
...
{
  $representative = User::findOrFail($representativeId);
  return view('Supervisor.target.create', compact('representative'));
}
...
public function storeTarget(Request $request, $representativeId)
{
  ...
  return redirect()->route('supervisor.representatives.index')->with('success', 'Monthly target created successfully.');
}
...
public function editTarget($representativeId, $targetId)
{
  ...
  return view('Supervisor.target.edit', compact('representative', 'target'));
}
...
public function updateTarget(Request $request, $representativeId, $targetId)
{
  ...
  return redirect()->route('supervisor.target.view', $representative->id)->with('success', 'Target updated successfully.');
}
...
public function deleteTarget($representativeId, $targetId)
{
  ...
  return redirect()->route('supervisor.target.view', $representative->id)->with('success', 'Target deleted successfully.');
}
}
