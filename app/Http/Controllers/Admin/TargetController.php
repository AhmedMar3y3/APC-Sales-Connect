...
class TargetController extends Controller
{
      ...
      public function viewTargets($representativeId)
      {
          ...
          return view('Admin.target.view', compact('representative', 'targets'));
      }
...
{
    $representative = User::findOrFail($representativeId);
    return view('Admin.target.create', compact('representative'));
}
...
public function storeTarget(Request $request, $representativeId)
{
    ...
    return redirect()->route('admin.representatives.index')->with('success', 'Monthly target created successfully.');
}
...
public function editTarget($representativeId, $targetId)
{
    ...
    return view('Admin.target.edit', compact('representative', 'target'));
}
...
public function updateTarget(Request $request, $representativeId, $targetId)
{
    ...
    return redirect()->route('admin.target.view', $representative->id)->with('success', 'Target updated successfully.');
}
...
public function deleteTarget($representativeId, $targetId)
{
    ...
    return redirect()->route('admin.target.view', $representative->id)->with('success', 'Target deleted successfully.');
}
