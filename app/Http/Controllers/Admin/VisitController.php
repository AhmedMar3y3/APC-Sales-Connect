...
class VisitController extends Controller
{
    public function showVisit($representativeId, $visitId)
    {
        ...
        if (!$representative || !$representative->visits->first()) {
            return redirect()->route('admin.representatives.index')->with('error', 'Visit not found');
        }

        $visit = $representative->visits->first();

        return view('Admin.representatives.visits', compact('representative', 'visit'));
    }
    public function create($representativeId)
    {
        ...
        $doctors = Doctor::all();
        return view('Admin.representatives.createVisit', compact('representative', 'medications', 'pharmacies', 'doctors'));
    }
    ...
    public function store(storeVisitRequest $request, $representativeId)
    {
        ...
        return redirect()->route('admin.representatives.show', $representativeId)
    ...
    public function edit($representativeId, $visitId)
    {
        ...
        return view('Admin.representatives.editVisit', compact('representative', 'visit', 'medications'));
    }
